...
public class Vending {
	...
	public void run() {
		...
		do {
			...
			case '5':
				System.out.println();
				total(gum, choco, juice, popcorn, gumTotalMoney, chocoTotalMoney, juiceTotalMoney, popcornTotalMoney);
				break;
			case '6':
				refill(gumPrim, chocoPrim, juicePrim, popcornPrim);
				break;
			case '7':
				left(gumPrim, chocoPrim, juicePrim, popcornPrim);
				break;
			case '8':
				break;
			default:
